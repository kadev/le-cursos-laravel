...
if (!function_exists('setTitle')) :
    function setTitle($page_name, $title = null) {

        // echo $page_name;

        $admin_name = '| Liderazgo Efectivo';

        if ($page_name === 'dashboard') :
            echo 'Dashboard - Liderazgo Efectivo';
        elseif ($page_name === 'sales') :
            echo 'Dashboard ' . $admin_name;


        //Courses
        elseif ($page_name === 'manage_courses') :
            echo 'Cursos ' . $admin_name;
        elseif($page_name === 'my_courses'):
            echo 'Mis cursos ' . $admin_name;
        elseif ($page_name === 'add_course') :
            echo 'Crear Curso ' . $admin_name;
        elseif ($page_name === 'edit_course') :
            echo 'Editar Curso ' . $admin_name;
        elseif ($page_name === 'course_details') :
            echo 'Detalles del curso ' . $admin_name;
        elseif ($page_name === 'see_course'):
            echo $title .' ' . $admin_name;
        elseif($page_name === 'config_class'):
            echo  'Configurar clase ' . $admin_name;

        // Prospects
        elseif ($page_name === 'manage_prospects') :
            echo 'Prospectos ' . $admin_name;
        elseif ($page_name === 'add_prospect'):
            echo 'Agregar prospecto '.$admin_name;
        elseif ($page_name === 'edit_prospect'):
            echo 'Editar prospecto'.$admin_name;
        elseif ($page_name === 'manage_users') :
            echo 'Usuarios ' . $admin_name;
        elseif ($page_name === 'add_user') :
            echo 'Nuevo usuario ' . $admin_name;

        //Events
        elseif ($page_name === 'manage_events') :
            echo 'Eventos ' . $admin_name;
        elseif ($page_name === 'add_event') :
            echo 'Crear Evento ' . $admin_name;
        elseif ($page_name === 'edit_event') :
            echo 'Editar Evento ' . $admin_name;
        elseif ($page_name === 'event_details') :
            echo 'Detalles del evento ' . $admin_name;
        elseif ($page_name === 'event_prospects') :
            echo 'Prospectos de evento ' . $admin_name;
        elseif ($page_name === 'edit_message_prospects') :
            echo 'Enviar mensaje a prospectos ' . $admin_name;

        //Links
        elseif ($page_name === 'manage_links') :
            echo 'Links ' . $admin_name;

        //Payments
        elseif ($page_name === 'manage_payments') :
            echo 'Pagos ' . $admin_name;
        ...
        elseif ($page_name === 'users') :
            echo 'Usuarios ' . $admin_name;
         elseif ($page_name === 'edit_user') :
            echo 'Editar usuario ' . $admin_name;
        elseif ($page_name === 'edit_profile') :
            echo 'Editar perfil ' . $admin_name;
        elseif ($page_name === 'account_settings') :
            echo 'Account Settings ' . $admin_name;
        elseif ($page_name === 'profile') :
            echo 'Mi perfil ' . $admin_name;

        elseif($page_name === 'system_options'):
            echo 'Configuración del sistema' . $admin_name;
        endif;
