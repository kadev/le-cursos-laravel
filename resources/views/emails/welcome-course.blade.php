                                            ...
                                            <p
                                                style="font-size: 30px; line-height: 1.2; word-break: break-word; text-align: left; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 36px; margin: 0;">
														<span style="font-size: 30px;"><strong><span
                                                                    style="font-size: 26px;">Hola {{ $user->name }},</span><br /></strong></span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p
                                                style="font-size: 16px; line-height: 1.2; word-break: break-word; text-align: left; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 19px; margin: 0;">
														<span style="font-size: 16px;">Gracias por adquirir nuestro curso:
															<strong>"{{ $course->title }}"</strong>,
															nuestro equipo de soporte te contactará para darte los detalles de la primera clase. <br /></span></p>
                                        </div>
                                    </div>
                                </div>
                                <!--<![endif]-->
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                             style="line-height: 1.2; font-size: 12px; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #555555; mso-line-height-alt: 14px;">
                                            <p
                                                style="font-size: 18px; line-height: 1.2; word-break: break-word; text-align: left; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 22px; margin: 0;">
                                                <span style="font-size: 18px;"><span style="font-size: 16px;">Ahora eres parte de la mejor comunidad de líderes en latinoamérica.</span><br /></span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <!--[if (!mso)&(!IE)]><!-->
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div align="center" class="button-container"
                                         style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px; display:none;">
