...
(function (root, factory) {
    ...
    */
    ...
    let embed = function(url, targetSelector, options){
        ...
        let fallbackHTML = "";
        let pdfOpenFragment = "";
        let fallbackHTML_default = "<p style='color: red; padding: 10px; border: 1px solid red;'>Este navegador no admite archivos PDF. Descargue el PDF para verlo: <a href='[url]'><u style='color: blue;'>Descargar PDF</u></a></p>";
